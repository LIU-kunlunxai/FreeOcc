...
#ifndef TENSOR_SCALAR_TYPE
  #if defined(TORCH_VERSION_MAJOR) && TORCH_VERSION_MAJOR >= 2
    #define TENSOR_SCALAR_TYPE(t) (t).scalar_type()
  #else
    #define TENSOR_SCALAR_TYPE(t) (t).type()
  #endif
#endif
    ...
    int radius)
{
  ...
  AT_DISPATCH_FLOATING_TYPES_AND_HALF(TENSOR_SCALAR_TYPE(volume), "sampler_forward_kernel", ([&] {
  ...
  int radius)
{
  ...
  AT_DISPATCH_FLOATING_TYPES_AND_HALF(TENSOR_SCALAR_TYPE(volume), "sampler_backward_kernel", ([&] {
